...
export const REDIR_REGN_HOME        = "REDIR_REGN_HOME";
export const REDIR_REGN_BANK        = "REDIR_REGN_BANK";
export const REDIR_REGN_FORM        = "REDIR_REGN_FORM";
export const REDIR_REGN_FORM_BANK   = "REDIR_REGN_FORM_BANK";
export const REDIR_REGN_EXISTS      = "REDIR_REGN_EXISTS";
export const REDIR_REGN_FORM_SUB    = "REDIR_REGN_FORM_SUB";
export const REDIR_REGN_RCD         = "REDIR_REGN_RCD";
export const CHANGE_REGN_INFO       = "CHANGE_REGN_INFO";
export const REDIR_RCV_CLAIM        = "REDIR_RCV_CLAIM";
export const REDIR_RCD_CLAIM        = "REDIR_RCD_CLAIM";
export const REDIR_SERV_HOME        = "REDIR_SERV_HOME";
export const REDIR_FAIL             = "REDIR_FAIL";
