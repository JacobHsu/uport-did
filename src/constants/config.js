...
export const myregistration = {
  ...
  text: {
    landingSteps: [
      "regnLandingStep1Bank",
      "regnLandingStep2Bank",
      "regnLandingStep3Bank"
    ]
  },
  form: {
    firstName: {
...
const BANK_ID = { // This should match the myregistration Config
  id: "BANK_ID",
  name: "Bank ID",
...
BANK_ID.generatedClaims = [FIRST_NAME, LAST_NAME, GENDERS, DATE_OF_BIRTH];
