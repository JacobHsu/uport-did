...
const { serviceId } = myregistration;

class RegistrationForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      details: Object.keys(myregistration.form).reduce((acc, val) => ({
        ...acc,
        [val]: myregistration.form[val].defaultValue
      }), {}),
        ...
        <Col span={6}>
          <Card CTA={CTA}>
            ...
            <Form onSubmit={this.handleSubmit}>
              <Grid>
                {Object.keys(myregistration.form).map(fieldId => createFormField(
                  fieldId,
                  myregistration.form[fieldId],
                  details[fieldId],
